...
const dict = {
  ...
  'avm.open': { tr: 'AVM koridorunda gör', en: 'See in a mall corridor', ar: 'شاهده في ممر المركز التجاري' },
  ...
  'dis.fill': { tr: 'Ekranı doldur', en: 'Fill the screen', ar: 'ملء الشاشة' },
  'dis.on': { tr: 'açık', en: 'on', ar: 'مفعّل' },
  'dis.off': { tr: 'kapalı', en: 'off', ar: 'معطّل' },
