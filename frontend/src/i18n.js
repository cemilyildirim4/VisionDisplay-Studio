...
const dict = {
  ...
  'scene.kioskWall': { tr: 'Duvara monte', en: 'Wall mounted', ar: 'مثبت على الحائط' },
  'scene.kioskTotem': { tr: 'Totem (tek ayak)', en: 'Totem (single leg)', ar: 'توتم (قائم واحد)' },
  'scene.kioskTwin': { tr: 'Çift ayak', en: 'Twin legs', ar: 'قائمان' },
  'scene.kioskHang': { tr: 'Tavandan askılı', en: 'Ceiling hung', ar: 'معلق من السقف' },
