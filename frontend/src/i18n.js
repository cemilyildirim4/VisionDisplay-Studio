...
const dict = {
  ...
  'arw.aimHint': { tr: 'Taslak kameranın baktığı yeri gösterir', en: 'The outline shows where the camera is aiming', ar: 'يوضّح المخطط المكان الذي تصوّبه الكاميرا' },
  'arw.place': { tr: 'Buraya yerleştir', en: 'Place here', ar: 'ضعها هنا' },
  'arw.noPlanes': { tr: 'Bu cihazda yüzey algılama yok — taslak kameranın önünde duruyor.', en: 'No surface detection on this device — the outline stays in front of the camera.', ar: 'لا يوجد اكتشاف أسطح على هذا الجهاز.' },
