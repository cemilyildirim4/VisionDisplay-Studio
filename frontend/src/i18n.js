...
const dict = {
  ...
  /* Bu yol e-posta/parola girişi; pratikte yönetici hesapları kullanıyor. */
  'gate.tabPassword': { tr: 'Admin', en: 'Admin', ar: 'المسؤول' },
  ...
  'cc.tab.invite': { tr: 'Davet kodu', en: 'Invite code', ar: 'رمز الدعوة' },
  'cc.invite.title': { tr: 'Davet kodu ile bayi girişi', en: 'Dealer sign-in with an invite code', ar: 'دخول الوكيل برمز دعوة' },
  'cc.invite.hint': { tr: 'Kullanıcı adınızı ve size verilen kodu girin; bayi hesabınızla oturum açılır.', en: 'Enter your user name and the code you were given; it opens your dealer session.', ar: 'أدخل اسم المستخدم والرمز الممنوح لك؛ يتم فتح جلسة الوكيل.' },
  'cc.invite.user': { tr: 'Kullanıcı adı', en: 'User name', ar: 'اسم المستخدم' },
  'cc.invite.userPlaceholder': { tr: 'ör. ahmet.yilmaz', en: 'e.g. john.smith', ar: 'مثال: ahmet.yilmaz' },
  'cc.invite.label': { tr: 'Kod', en: 'Code', ar: 'الرمز' },
  'cc.invite.submit': { tr: 'Kodu doğrula', en: 'Verify code', ar: 'تحقق من الرمز' },
  'cc.invite.busy': { tr: 'Kontrol ediliyor…', en: 'Checking…', ar: 'جارٍ التحقق…' },
  'cc.invite.invalid': { tr: 'Kullanıcı adı veya davet kodu geçersiz.', en: 'Invalid user name or invite code.', ar: 'اسم المستخدم أو رمز الدعوة غير صالح.' },
  'cc.invite.network': { tr: 'Sunucuya ulaşılamadı. Bağlantınızı kontrol edin.', en: 'Could not reach the server. Check your connection.', ar: 'تعذر الوصول إلى الخادم. تحقق من اتصالك.' },
  ...
  'scene.suggest': { tr: 'En uygun yere yerleştir', en: 'Place at best spot', ar: 'ضعه في أنسب مكان' },
  ...
  'scene.viewAngle': { tr: 'Bakış açısı', en: 'Viewing angle', ar: 'زاوية النظر' },
  'scene.viewAngleHint': { tr: 'Ekranın hangi yönden görüldüğünü seçin; tasarım o açıyla yerleşir.', en: 'Choose the direction the screen is seen from; the design follows that angle.', ar: 'اختر الاتجاه الذي تُرى منه الشاشة.' },
  'scene.angleFarLeft': { tr: 'Çok sol', en: 'Far left', ar: 'أقصى اليسار' },
  'scene.angleLeft': { tr: 'Sol', en: 'Left', ar: 'يسار' },
  'scene.angleFront': { tr: 'Karşı', en: 'Front', ar: 'أمام' },
  'scene.angleRight': { tr: 'Sağ', en: 'Right', ar: 'يمين' },
  'scene.angleFarRight': { tr: 'Çok sağ', en: 'Far right', ar: 'أقصى اليمين' },
  'scene.angleAbove': { tr: 'Yukarıdan', en: 'From above', ar: 'من الأعلى' },
  'scene.angleLevel': { tr: 'Göz hizası', en: 'Eye level', ar: 'مستوى النظر' },
  'scene.angleBelow': { tr: 'Aşağıdan', en: 'From below', ar: 'من الأسفل' },
  'scene.angleOn': { tr: 'Açıyı elle ayarla', en: 'Adjust angle by hand', ar: 'ضبط الزاوية يدويًا' },
  'scene.angleOff': { tr: 'Açı ayarını bitir', en: 'Finish angle adjustment', ar: 'إنهاء ضبط الزاوية' },
  'scene.angleReset': { tr: 'Açıyı sıfırla', en: 'Reset angle', ar: 'إعادة ضبط الزاوية' },
  'scene.spots': { tr: 'Diğer yerler', en: 'Other spots', ar: 'أماكن أخرى' },
  'scene.spotsOff': { tr: 'Yerleri gizle', en: 'Hide spots', ar: 'إخفاء الأماكن' },
  'scene.spotsHint': {
  ...
  'exp.missingModel': { tr: 'model onayı', en: 'model confirmation', ar: 'تأكيد الطراز' },
  'exp.missingConsent': { tr: 'aydınlatma metni onayı', en: 'privacy consent', ar: 'الموافقة على إشعار الخصوصية' },
  'exp.missingLogin': { tr: 'oturum açma', en: 'sign-in', ar: 'تسجيل الدخول' },
