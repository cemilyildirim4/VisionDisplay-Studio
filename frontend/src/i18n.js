...
const dict = {
  ...
  'cc.invite.title': { tr: 'Davet kodu ile giriş', en: 'Sign in with an invite code', ar: 'الدخول برمز دعوة' },
  'cc.invite.hint': { tr: 'Kullanıcı adınızı ve size verilen kodu girin; 24 saatlik misafir erişimi açılır.', en: 'Enter your user name and the code you were given; it opens 24-hour guest access.', ar: 'أدخل اسم المستخدم والرمز الممنوح لك؛ يفتح وصول ضيف لمدة 24 ساعة.' },
