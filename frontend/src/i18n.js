...
const dict = {
  ...
  'cc.login.hint': {
    tr: 'Hesabınız yönetici tarafından açılır. E-posta ve parolanız varsa giriş yapın.',
    en: 'Accounts are created by an administrator. Sign in with your email and password.',
    ar: 'يفتح المسؤول الحساب. سجّل الدخول بالبريد الإلكتروني وكلمة المرور إن وُجدت.',
  },
