                  ...
                  >
                    <div className="flex flex-col md:flex-row flex-wrap items-stretch md:items-center justify-between gap-2 md:gap-3 max-w-full">
                      ...
                      <button
                        ...
                        className="rounded-full border border-neutral-300 dark:border-[#39414f] px-4 min-h-[44px] py-2.5 text-[12px] font-semibold hover:border-brand transition-colors whitespace-nowrap inline-flex items-center justify-center w-full md:w-auto max-w-full"
                      >
